...
export function HomePage() {
  ...
  return (
    <div ref={containerRef} className="relative w-full overflow-hidden pb-16">
      ...
      {/* 1. Hero Section */}
      <section className="relative min-h-[65vh] flex flex-col items-center justify-center px-4 pt-24 pb-8 mt-8 z-10 max-w-7xl mx-auto">
        ...
        <div className="absolute bottom-[-48px] left-[-20%] right-[-20%] z-20 w-[140%] overflow-hidden h-20 flex items-center justify-center pointer-events-none">
          <div 
